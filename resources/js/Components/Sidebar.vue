...
const navGroups = [
    ...
    },
    {
        ...
        items: [
            { name: 'My Profile', href: route('profile.show'), icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
    ...
    {
        title: 'Children',
        icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1.5a4.5 4.5 0 014.5-4.5h3a4.5 4.5 0 014.5 4.5V21zM19 8v3m0 3v-3m-3 0h3m3 0h-3',
        items: [
            { name: 'Coming Soon', href: '#', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1.5a4.5 4.5 0 014.5-4.5h3a4.5 4.5 0 014.5 4.5V21z' },
        ],
    },
    {
        title: 'Blood Glucose',
        ...
        items: [
            { name: 'Coming Soon', href: '#', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
        ],
    },
    {
        title: 'Meals & Insulin',
        icon: 'M12 8v13m-8-8h16m-1 0l-4-4m4 4l-4 4',
        items: [
            { name: 'Coming Soon', href: '#', icon: 'M12 8v13m-8-8h16m-1 0l-4-4m4 4l-4 4' },
        ],
    },
    {
        title: 'Appointments',
        ...
        items: [
            { name: 'Coming Soon', href: '#', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
        ],
    },
];
